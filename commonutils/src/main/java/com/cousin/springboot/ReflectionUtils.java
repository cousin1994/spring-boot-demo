...
public class ReflectionUtils {
     ...
     */
    private static void invokeSetterMethod(Object target, String propertyName,
     ...
     * determined
     */
    private static Class getSuperClassGenricType(final Class clazz,
                                                 final int index) {
     ...
     */
    private static List convertElementPropertyToList(
     ...
     */
    private static RuntimeException convertReflectionExceptionToUnchecked(
            Exception e) {
